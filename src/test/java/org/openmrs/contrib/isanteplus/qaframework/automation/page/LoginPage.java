...
public class LoginPage extends Page {
    ...
    static final By FIELD_USERNAME = By.id("username");
    static final By FIELD_PASSWORD = By.id("password");
    static final By BUTTON_LOGIN = By.id("loginButton");
	...
	public WebElement getLoginButton() {
		return findElement(BUTTON_LOGIN);
	}
